...
const Landing = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <h2 className="my-10 sm:my-16 text-3xl sm:text-6xl lg:text-7xl font-extrabold  text-white text-center">
      ...
      <Accordion type="multiple" collapsible className="w-full md:px-11">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            that URL. -This shortened URL redirects to the original long URL
            when accessed.
          </AccordionContent>
        </AccordionItem>
